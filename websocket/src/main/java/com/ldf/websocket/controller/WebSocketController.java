package com.ldf.websocket.controller;



import com.ldf.websocket.domain.Message;
import com.ldf.websocket.domain.Response;
import com.ldf.websocket.service.WebSocketService;
...
public class WebSocketController {
    ...
    public Response say2()throws Exception
    {
        ws.sendMessage();
        return new Response("-----");
    }
